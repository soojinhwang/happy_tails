class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :age, :biography, :type_of_dwelling, :outdoor_space, :other_pets, :children, :hours_alone, :previous_experience ])
